...
**LittleVec** — это легковесная и очень эффективная по памяти векторная база данных.  
Идеально подходит для размещения на самых маломощных серверах.  
LittleVec реализована в качестве плагина к [RocksServer](https://github.com/valmat/RocksServer).
